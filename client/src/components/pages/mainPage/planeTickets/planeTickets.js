...
const PlaneTickets = ({fetchedTickets, addParametersOfSearching}) => {
    ...
    const [classOfTicket, setClassOfTicket] = useState(t('label1'));
    ...
    const buttons = [
        {filterType: 'all', label: t('label1')},
        {filterType: 'business', label: t('label2')},
        {filterType: 'ekonom', label: t('label3')}
    ];
            ...
            <Container className="p-0 m-0">
                <Row className="p-1 m-1 align-items-center br-b">
                    ...
                    <Col className="p-0 col count-of-place-cont">
                        <fieldset className="inputGroup">
                            <input value={`${countOfPassanger}, ${classOfTicket}`} className="home-font qqq inputGroup_input_last inp_span" onClick={() => setVisible(true)} placeholder="Пасажири, клас"/>
                        </fieldset>
...
export default connect(mapStateToProps, mapDispatchToProps)(PlaneTickets)